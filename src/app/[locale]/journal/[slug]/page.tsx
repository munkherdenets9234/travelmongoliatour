  ...
  return (
    <>
      ...
      <div className="flex items-center gap-3.5 container mx-auto px-6 sm:px-14 py-5 border-b border-border">
        ...
        <div className="flex-1">
          ...
          <div className="text-xs text-warm-gray">
            {article.author.role} · {new Date(article.date).toLocaleDateString('en-US', { month: 'long', day: 'numeric', year: 'numeric' })}
          </div>
        </div>
        <span className="hidden sm:inline-flex items-center gap-2 border border-border-strong rounded-sm px-4 py-2.5 text-xs font-semibold tracking-widest uppercase">↗ Share</span>
        <span className="hidden sm:inline-flex items-center gap-2 border border-border-strong rounded-sm px-4 py-2.5 text-xs font-semibold tracking-widest uppercase">♡ Save</span>
      </div>
      ...
      <section className="bg-olive text-cream container mx-auto px-6 sm:px-14 py-12 flex flex-wrap items-center justify-between gap-6">
        <div>
          <div className="text-cream/75 text-xs font-semibold tracking-[0.22em] uppercase">See it yourself</div>
          <div className="font-display text-3xl mt-2">
            Tours that match this <span className="italic">guide</span>.
          </div>
        </div>
      ...
      <div className="container mx-auto px-6 sm:px-14 py-10">
        <div className="font-display text-2xl mb-5">Keep reading</div>
