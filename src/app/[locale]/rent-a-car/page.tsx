...
const typeValues = ['suv', 'van', 'furgon', 'sedan']
  ...
  return (
    <>
      ...
      <div className="container mx-auto px-6 sm:px-14 pt-8">
        <FilterChips
          chips={[
            { label: t.all_vehicles, href: base, active: !type },
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 container mx-auto px-6 sm:px-14 py-8">
        ...
        <article className="rounded-md bg-ink text-cream flex flex-col items-center justify-center text-center p-8 shadow-[0_10px_26px_rgba(30,27,22,0.12)]">
          ...
          <div className="font-display text-2xl">{t.need_fleet_heading}</div>
          <p className="text-sm text-cream/65 mt-2 mb-4">{t.need_fleet_text}</p>
      ...
      <div className="bg-olive text-cream container mx-auto px-6 sm:px-14 py-8 flex flex-wrap gap-8 items-center justify-center">
        <div className="flex items-center gap-2.5 text-sm font-medium"><span>✓</span> {t.insurance_note}</div>
        <div className="flex items-center gap-2.5 text-sm font-medium"><span>✓</span> {t.roadside_note}</div>
        <div className="flex items-center gap-2.5 text-sm font-medium"><span>✓</span> {t.camping_note}</div>
      </div>
    </>
  )
}
